...
class Grammar(object):
    ...
    def __init__(self, file_name):
       ...
       # print("In GRAMMAR: ", params['INITIALISATION'].ramping)  # ADDED By Roisin - REMOVE
        ...
        if params['MIN_INIT_TREE_DEPTH']:
           ...
           # print("In GRAMMAR: ",self.min_ramp) #ADDED By Roisin - REMOVE
    ...
    def get_min_ramp_depth(self):
        ...
        print("unique_start=", unique_start)
        ramp = None

        print(self.permutations.keys() )
        for i in sorted(self.permutations.keys()):
            #print('i=', i, self.permutations[i])
